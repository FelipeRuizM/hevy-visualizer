...
import { LayoutDashboard, Activity, BarChart3, CalendarDays, Settings as SettingsIcon, Trophy, ChevronsLeft, ChevronsRight, Dumbbell, Footprints, Calculator } from 'lucide-react';
import './Sidebar.css';
